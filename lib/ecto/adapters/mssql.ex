defmodule Ecto.Adapters.MSSQL do
  ...
  [Mssqlex documentation](https://hexdocs.pm/postgrex/Mssqlex.html#start_link/1)
  ...
  example, in your repository configuration you can add:
      ...
      after_connect: {Mssqlex, :query!, ["SET search_path TO global_prefix", []]}

  You can also specify your own module that will receive the Mssqlex
  connection as argument.

  ## Extensions

  Both MSSQL and its adapter for Elixir, Mssqlex, support an
  extension system. If you want to use custom extensions for Mssqlex
  ...
  Create a new file anywhere in your application with the following:
      ...
      Mssqlex.Types.define(MyApp.PostgresTypes,
  ...
  @default_maintenance_database "master"
